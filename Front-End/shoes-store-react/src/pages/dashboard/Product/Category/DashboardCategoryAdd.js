        ...
        <Layout>
            <div className="container-fluid p-5">
                ...
                <p className="sub-title">
                    Trang thêm mới danh mục sản phẩm vào hệ thống
                </p>
                <hr width={'100%'}/>
                <Formik initialValues={initValues} onSubmit={(values) => handleSubmitFormAdd(values)} validationSchema={categoriesSchema}>
                    <Form>
                        <div className="mb-3">
